...
import 'package:flutter/foundation.dart' show DiagnosticsProperty, DiagnosticsTreeStyle;
import 'package:flutter/material.dart';

class CalendarScrollPhysics extends ScrollPhysics {
  /// Creates scroll physics that prevent the scroll offset from exceeding the
  /// bounds of the content.
  const CalendarScrollPhysics({super.parent});

  @override
  CalendarScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return CalendarScrollPhysics(parent: buildParent(ancestor));
  }
